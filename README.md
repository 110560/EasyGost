...
> 脚本简介
> > 适合懒人的超简单gost一键转发脚本:  
> > `wget --no-check-certificate -O gost.sh https://raw.githubusercontent.com/upczhanghao/EasyGost/master/gost.sh && chmod +x gost.sh && ./gost.sh`  
...
> > 项目地址及帮助文档:  
> > https://github.com/upczhanghao/EasyGost  
***
## 本一键脚本适用人群  
