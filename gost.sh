...
function Install_ct()
{
    ...
    `wget --no-check-certificate https://raw.githubusercontent.com/upczhanghao/EasyGost/master/gost.service && chmod -R 777 gost.service && mv gost.service /usr/lib/systemd/system`
    `mkdir /etc/gost && wget --no-check-certificate https://raw.githubusercontent.com/upczhanghao/EasyGost/master/config.json && mv config.json /etc/gost && chmod -R 777 /etc/gost`
